...
@section('content')
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active"><a href="#">Employee</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="text-sm-right">
                                                ...
                                                <a href="#custom-modal" data-bs-backdrop="static" data-keyboard="false" class="btn btn-primary waves-effect waves-light mb-2" data-animation="fadein" data-plugin="custommodal" data-overlayColor="#38414a"><i class="mdi mdi-plus-circle mr-1"></i> Add Employee</a>
                                            </div>
                                        </div><!-- end col-->
                                    </div>
                                 <!--  Search-->
   ...
   >
    ...
    <form action="{{route('store.crm.employee')}}" method="POST" id="employeeForm">
        @csrf
